...
import { sendParentConnectionRequest } from "@/lib/connections/server";
...
const invalidRequest = {
  ...
  error: {
    ...
    message: "Yêu cầu kết nối không hợp lệ.",
  },
};
...
export async function POST(request: NextRequest) {
  ...
  const result = await sendParentConnectionRequest(studentCode);
