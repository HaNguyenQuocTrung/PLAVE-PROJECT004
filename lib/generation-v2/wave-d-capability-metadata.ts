...
export const WAVE_D_CAPABILITY_METADATA = {
  ...
  APPLIED_RATIONAL_REASONING: m("ARITHMETIC", "model a signed rational measurement or rate exactly", ["FRACTION_INPUT", "DECIMAL_INPUT"], "NUMBER_LINE", "reduced rational or controlled decimal", "sign and rational-operation error"),
  AREA_PERIMETER: m("GEOMETRY_2D", "distinguish boundary from covered region and calculate from dimensions", ["INTEGER_INPUT", "DECIMAL_INPUT"], "AREA_MODEL", "exact length or square-unit measure", "perimeter-area confusion"),
  ...
  CIRCLE_MEASURE: m("GEOMETRY_2D", "calculate circumference, arc, sector, annulus or circle-based application", ["DECIMAL_INPUT", "INTEGER_INPUT"], "AREA_MODEL", "controlled rounded measure", "radius-diameter and sector fraction error"),
  CIRCLE_RELATION: m("GEOMETRY_2D", "classify tangent/chord/symmetry or relative-position constraints", ["SINGLE_CHOICE", "MULTI_SELECT"], "SHAPE_DIAGRAM", "unique relation classification", "secant-tangent and chord confusion"),
  ...
  FUNCTION_MODEL_RECOGNITION: m("ALGEBRA", "distinguish functional from non-functional input-output relations", ["SINGLE_CHOICE", "MULTI_SELECT"], "DATA_TABLE", "unique relation classification", "repeated-input function error"),
  ...
  GEOMETRIC_PROOF_REASONING: m("GEOMETRY_2D", "order premises, justified deductions and conclusion", ["ORDERING", "MATCHING"], "SHAPE_DIAGRAM", "canonical proof sequence", "unsupported conclusion"),
  ...
  LINEAR_GRAPH_RELATION: m("COORDINATE", "use exact slopes to classify two lines", ["SINGLE_CHOICE", "MATCHING"], "COORDINATE_GRAPH", "slope or line relation", "parallel-intersection confusion"),
  LINE_RELATION: m("GEOMETRY_2D", "classify intersecting, parallel or perpendicular lines from exact constraints", ["SINGLE_CHOICE", "MULTI_SELECT"], "SHAPE_DIAGRAM", "unique line relation", "parallel-perpendicular confusion"),
  ...
  NATURAL_NUMBER_STRUCTURE: m("ARITHMETIC", "identify decimal place structure or successor/predecessor properties", ["INTEGER_INPUT", "ORDERING"], "PLACE_VALUE_CHART", "whole number or ordering", "place-value confusion"),
  ...
  SOLID_PROPERTIES: m("GEOMETRY_3D", "identify exact faces, edges, vertices or named solid elements", ["SINGLE_CHOICE", "MULTI_SELECT"], "SHAPE_DIAGRAM", "property count or set", "face-edge-vertex confusion"),
  SOLID_SURFACE_VOLUME: m("GEOMETRY_3D", "calculate surface area or volume from complete dimensions", ["INTEGER_INPUT", "DECIMAL_INPUT"], "MEASUREMENT_MODEL", "exact or controlled rounded measure", "surface-volume and formula error"),
  ...
  TIME_CALENDAR: m("TIME", "read a clock/calendar or convert bounded time units", ["INTEGER_INPUT", "MATCHING"], "MEASUREMENT_MODEL", "time value or ordered day/month", "hour-minute and calendar-order error"),
  TRIANGLE_CONGRUENCE: m("GEOMETRY_2D", "identify congruence from corresponding exact data", ["SINGLE_CHOICE", "MATCHING"], "SHAPE_DIAGRAM", "valid congruence case or correspondence", "congruence-similarity confusion"),
  ...
  UNIT_CONVERSION_MEASUREMENT: m("MEASUREMENT", "read or convert an explicit length, mass, capacity, area, temperature or time unit", ["INTEGER_INPUT", "DECIMAL_INPUT"], "MEASUREMENT_MODEL", "exact scaled measure", "unit-dimension or scale error"),
