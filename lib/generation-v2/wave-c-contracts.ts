...
const SPECS = [
  ...
  s("MOET2018-G5-NUM-P041-008", 5, "DECIMAL_REPRESENTATION", "DECIMAL_PLACE_VALUE", "DECIMAL", ["INTEGER_INPUT", "DECIMAL_INPUT"], "Xác định phần nguyên, phần thập phân và giá trị một hàng thập phân."),
  ...
  s("MOET2018-G8-NAA-P064-018", 8, "FUNCTION_EVALUATION", "FUNCTION_VALUE", "FUNCTION", ["INTEGER_INPUT", "FRACTION_INPUT"], "Tính giá trị hàm số từ công thức tại một đầu vào cho trước."),
